...
SELECT admin.fn_get_total_scans_by_date_range(1, '2021-10-31'::DATE, '2021-11-06'::DATE) AS total_scans;
...
SELECT admin.fn_get_average_user_visit_by_date_range(1, '2021-10-31'::DATE, '2021-11-06'::DATE) AS average_user_visit;
...
-- Note how independent TODAYs stats are from in relation to previous stats. (Make it like Today, Last 7 days, Month, Year, etc).
SELECT _exhibit_id AS exhibit_id, _name AS name, _image AS image, _most_scans_from_range AS most_scans_from_range
FROM admin.fn_get_most_popular_exhibit_by_date_range(1, '2021-11-07'::DATE, '2021-11-07'::DATE);

SELECT _exhibit_id AS exhibit_id, _name AS name, _image AS image, _most_scans_from_range AS most_scans_from_range
FROM admin.fn_get_most_popular_exhibit_by_date_range(1, '2021-11-06'::DATE, '2021-11-07'::DATE);

SELECT _exhibit_id AS exhibit_id, _name AS name, _image AS image, _most_scans_from_range AS most_scans_from_range
FROM admin.fn_get_most_popular_exhibit_by_date_range(1, '2021-11-06'::DATE, '2021-11-06'::DATE);

SELECT _exhibit_id AS exhibit_id, _name AS name, _image AS image, _most_scans_from_range AS most_scans_from_range
FROM admin.fn_get_most_popular_exhibit_by_date_range(1, '2021-10-31'::DATE, '2021-11-06'::DATE);